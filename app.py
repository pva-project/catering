...
# --- 1. STILIZACIJA (Moderni Dashboard Dizajn) ---
...
st.markdown("""
    ...
    /* Indikatori boja sa glow efektom */
    ...
    /* Dugme za print (Moderno i upečatljivo) */
...
if not st.session_state["logged_in"]:
    ...
    if st.session_state["user"] == "admin":
        ...
        with t1: # KUHINJA + DASHBOARD STATUSI
        ...
        with t3: # OCJENE + DASHBOARD
            ...
            if pk:
                ...
                for i, (k, v) in enumerate(pk.items()): cols[i].metric(k, f"{v} ⭐")
